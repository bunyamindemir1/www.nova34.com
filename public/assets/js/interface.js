( function($) {
  'use strict';
			    ...
			    submitHandler: function(form){
		        	...
		        	$.ajax({
			            ...
			            success: function(response) {
                            $('.form-submit :input[type="submit"]').prop('disabled', true);

                            setTimeout(function(){
                                if (response.errors){
                                    $('#loading').hide();
                                    $('.col-message, .error-message').show();
                                    $('.col-message .form-group').html('<div class="error-message" style="display: block;">'+response.errors+'</div>');
                                }
                                if (response.success){
                                    $('#loading').hide();
                                    Swal.fire({
                                ...
                                $('.form-submit :input[type="submit"]').prop('disabled', false);
                            }, 2000);
    ...
    /*-------------------------------------------------------------------------------
      Scroll contact-fix show or hide
    -------------------------------------------------------------------------------*/
    ...
    $("#language").change(function(){
        const language_url =  $(this).data('language');


        window.location.href = language_url + "?lang="+ $(this).val();
    });
})(jQuery);
